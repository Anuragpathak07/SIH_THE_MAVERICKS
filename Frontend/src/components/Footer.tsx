    ...
    <footer className="border-t bg-white/70 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 className="text-lg font-semibold text-foreground mb-3">MineGuard AI</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/70">
              <li className="flex items-center gap-2"><Mail className="w-4 h-4" /> contact@mineguard.ai</li>
        ...
        <div className="mt-10 text-xs text-foreground/50">© {new Date().getFullYear()} MineGuard AI. All rights reserved.</div>
      </div>
    </footer>
  );
};
